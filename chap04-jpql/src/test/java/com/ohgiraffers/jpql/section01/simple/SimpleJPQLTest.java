...
public class SimpleJPQLTest {
    ...
    *    객체 지향 쿼리이다. SQL 보다 간결하며 특정 DBMS에 의존 하지 않는다.
    ...
    *    order by
    *    삽입
    *    EntityManager 가 제공하는 persist() 메소드를 사용하면 된다.
    *    수정
    *    update
    *    set
    *    [where]
    ...
    *   필기.
    *       [JPQL 사용 방법]
    *       1. 작성한 JPQL 을 entityManager.createQuery() 메소드를 통해 쿼리 객체로 만듬
    ...
    * */
    ...
    void testSingleMenuByTypedQuery(){
        ...
        Assertions.assertEquals(repository.findMenu(8).getMenuName(), "한우딸기국밥");
